...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        register_button.setOnClickListener {
            ...
            val phone_1 = register_numberphone_family_memmbers_1.text.toString()
//            val phone_2 = register_phone_text_view_2.text.toString()
//            val phone_3 = register_phone_text_view_3.text.toString()
            if(name.isEmpty() || email.isEmpty() || password.isEmpty() || phone_1.isEmpty())
            {
            ...
            Log.d("RegisterActivity","phone_1:"+ phone_1)
...
//            Log.d("RegisterActivity","phone_3:"+ phone_3)
    ...
    private fun saveUserToFirebaseDatabase() {
        ...
        val user = User(uid, register_username_text_view.text.toString(),register_email_text_view.text.toString(),register_numberphone_family_memmbers_1.text.toString() )
